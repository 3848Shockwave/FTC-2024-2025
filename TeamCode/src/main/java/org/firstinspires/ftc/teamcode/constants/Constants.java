...
public final class Constants {
    ...
    public static int HORIZONTAL_CLAW_ROLL_FLAT_POSITION = 3;
    public static int HORIZONTAL_CLAW_ROLL_UP_POSITION = 105;
    ...
    // vertical
    //claw
    public static double VERTICAL_CLAW_GRIP_OPEN_POSITION = 150;
    public static double VERTICAL_CLAW_GRIP_CLOSED_POSITION = 90;
    ...
    public static double VERTICAL_CLAW_PITCH_WALL_POSITION = 265;
    ...
    public static double VERTICAL_WRIST_PITCH_WALL_POSITION = 310;
    // SPECIMEN
