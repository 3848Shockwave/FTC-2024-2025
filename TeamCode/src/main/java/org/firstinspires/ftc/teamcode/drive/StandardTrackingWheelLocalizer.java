...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.00263609741; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.01135481766; // Multiplier in the Y direction
